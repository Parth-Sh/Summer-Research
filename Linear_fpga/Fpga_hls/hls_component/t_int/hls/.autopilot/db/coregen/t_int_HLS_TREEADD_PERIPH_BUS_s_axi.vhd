...
entity t_int_HLS_TREEADD_PERIPH_BUS_s_axi is
generic (
...
end entity t_int_HLS_TREEADD_PERIPH_BUS_s_axi;
...
architecture behave of t_int_HLS_TREEADD_PERIPH_BUS_s_axi is
    ...
    constant ADDR_D_DATA_0    : INTEGER := 16#28#;
    constant ADDR_D_CTRL      : INTEGER := 16#2c#;
    constant ADDR_E_DATA_0    : INTEGER := 16#30#;
    constant ADDR_E_CTRL      : INTEGER := 16#34#;
    constant ADDR_F_DATA_0    : INTEGER := 16#38#;
    constant ADDR_F_CTRL      : INTEGER := 16#3c#;
    constant ADDR_G_DATA_0    : INTEGER := 16#40#;
    constant ADDR_G_CTRL      : INTEGER := 16#44#;
    constant ADDR_H_DATA_0    : INTEGER := 16#48#;
    constant ADDR_H_CTRL      : INTEGER := 16#4c#;
    constant ADDR_R_DATA_0    : INTEGER := 16#50#;
    constant ADDR_R_CTRL      : INTEGER := 16#54#;
    constant ADDR_DONE_DATA_0 : INTEGER := 16#60#;
    constant ADDR_DONE_CTRL   : INTEGER := 16#64#;
    ...
    signal int_e               : UNSIGNED(31 downto 0) := (others => '0');
    signal int_f               : UNSIGNED(31 downto 0) := (others => '0');
    ...
    signal int_done            : UNSIGNED(15 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_E_DATA_0 =>
                        rdata_data <= RESIZE(int_e(31 downto 0), 32);
                    when ADDR_F_DATA_0 =>
                    ...
                    when ADDR_DONE_DATA_0 =>
                        rdata_data <= RESIZE(int_done(15 downto 0), 32);
                    when ADDR_DONE_CTRL =>
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_e(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_E_DATA_0) then
                    int_e(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_e(31 downto 0));
                end if;
            end if;
        end if;
    end process;
