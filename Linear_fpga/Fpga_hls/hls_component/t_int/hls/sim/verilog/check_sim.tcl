...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.t_int.autotvin_a.dat"
         "c.t_int.autotvin_b.dat"
         "c.t_int.autotvin_c.dat"
         "c.t_int.autotvin_d.dat"
         "c.t_int.autotvin_e.dat"
         "c.t_int.autotvin_f.dat"
         "c.t_int.autotvin_g.dat"
         "c.t_int.autotvin_h.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.t_int.autotvout_r.dat"
         "rtl.t_int.autotvout_done.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
