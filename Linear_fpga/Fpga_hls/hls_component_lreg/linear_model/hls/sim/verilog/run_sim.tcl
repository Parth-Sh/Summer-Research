...
if {[file isfile linear_model.autotvin.dat]} {
	file delete -force linear_model.autotvin.dat
}

if {[file isfile linear_model.autotvout.dat]} {
	file delete -force linear_model.autotvout.dat
}
