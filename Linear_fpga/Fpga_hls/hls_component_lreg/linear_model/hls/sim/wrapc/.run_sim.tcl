...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "linear_model.autotvin.dat"
	set constFileTvOut       "linear_model.autotvout.dat"
	set constFileHdlTvIn     "linear_model.autohdltvin.dat"
	set constFileHdlTvOut    "linear_model.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
