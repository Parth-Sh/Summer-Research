...
#define XPAR_XLINEAR_MODEL_NUM_INSTANCES 1

/* Definitions for peripheral LINEAR_MODEL_0 */
#define XPAR_LINEAR_MODEL_0_COMPATIBLE "xlnx,linear-model-1.0"
#define XPAR_LINEAR_MODEL_0_BASEADDR 0x40000000
#define XPAR_LINEAR_MODEL_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral LINEAR_MODEL_0 */
#define XPAR_XLINEAR_MODEL_0_BASEADDR 0x40000000
#define XPAR_XLINEAR_MODEL_0_HIGHADDR 0x4000ffff
#define XPAR_XLINEAR_MODEL_0_COMPATIBLE "xlnx,linear-model-1.0"
