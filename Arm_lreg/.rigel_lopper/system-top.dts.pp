# 1 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  linear_model_0: linear_model@40000000 {
   compatible = "xlnx,linear-model-1.0";
   xlnx,ii = <3>;
   xlnx,machine = <64>;
   xlnx,ip-name = "linear_model";
   xlnx,s-axi-hls-linear-periph-bus-addr-width = <6>;
   reg = <0x40000000 0x10000>;
   clocks = <&clkc 15>;
   xlnx,clk-period = <10>;
   xlnx,edk-iptype = "PERIPHERAL";
   status = "okay";
   xlnx,s-axi-hls-linear-periph-bus-data-width = <32>;
   clock-names = "ap_clk";
   xlnx,combinational = <0>;
   xlnx,latency = <2>;
   xlnx,name = "linear_model_0";
  };
 };
};
# 4 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
...
# 5 "D:\\ELEC_522\\FpgaEx\\Arm_lreg\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7z020";
 slrcount = <1>;
 family = "Zynq";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &linear_model_0 0x40000000 0x10000>,
