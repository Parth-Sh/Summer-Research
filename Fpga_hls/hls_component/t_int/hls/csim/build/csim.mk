...
HLS_SOURCES = ../../../../../t_int_test.cpp ../../../../../t_int.cpp
...
$(ObjDir)/t_int_test.o: ../../../../../t_int_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../t_int_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/t_int_test.d

$(ObjDir)/t_int.o: ../../../../../t_int.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../t_int.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/t_int.d
