...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "t_int.autotvin.dat"
	set constFileTvOut       "t_int.autotvout.dat"
	set constFileHdlTvIn     "t_int.autohdltvin.dat"
	set constFileHdlTvOut    "t_int.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
