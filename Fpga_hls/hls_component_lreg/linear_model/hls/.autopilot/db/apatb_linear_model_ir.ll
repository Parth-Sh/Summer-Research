; ModuleID = 'D:/ELEC_522/FpgaEx/Fpga_hls/hls_component_lreg/linear_model/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline willreturn
define void @apatb_linear_model_ir(i32 %x, i32 %m, i32 %c, i32* noalias nocapture nonnull %y, i16* noalias nocapture nonnull %done) local_unnamed_addr #0 {
entry:
  %y_copy = alloca i32, align 512
  %done_copy = alloca i16, align 512
  call fastcc void @copy_in(i32* nonnull %y, i32* nonnull align 512 %y_copy, i16* nonnull %done, i16* nonnull align 512 %done_copy)
  call void @apatb_linear_model_hw(i32 %x, i32 %m, i32 %c, i32* %y_copy, i16* %done_copy)
  call void @copy_back(i32* %y, i32* %y_copy, i16* %done, i16* %done_copy)
  ret void
}
...
declare void @apatb_linear_model_hw(i32, i32, i32, i32*, i16*)
...
declare void @linear_model_hw_stub(i32, i32, i32, i32* noalias nocapture nonnull, i16* noalias nocapture nonnull)

define void @linear_model_hw_stub_wrapper(i32, i32, i32, i32*, i16*) #4 {
entry:
  call void @copy_out(i32* null, i32* %3, i16* null, i16* %4)
  call void @linear_model_hw_stub(i32 %0, i32 %1, i32 %2, i32* %3, i16* %4)
  call void @copy_in(i32* null, i32* %3, i16* null, i16* %4)
  ret void
}
