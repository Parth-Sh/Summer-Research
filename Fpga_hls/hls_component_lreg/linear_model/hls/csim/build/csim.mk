...
HLS_SOURCES = ../../../../../l_reg_test.cpp ../../../../../l_reg.cpp
...
$(ObjDir)/l_reg_test.o: ../../../../../l_reg_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../l_reg_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -DHW_COSIM -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/l_reg_test.d

$(ObjDir)/l_reg.o: ../../../../../l_reg.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../l_reg.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/l_reg.d
