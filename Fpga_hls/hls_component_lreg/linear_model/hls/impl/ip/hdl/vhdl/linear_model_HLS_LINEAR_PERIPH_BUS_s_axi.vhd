...
entity linear_model_HLS_LINEAR_PERIPH_BUS_s_axi is
generic (
...
end entity linear_model_HLS_LINEAR_PERIPH_BUS_s_axi;
...
architecture behave of linear_model_HLS_LINEAR_PERIPH_BUS_s_axi is
    ...
    constant ADDR_Y_DATA_0    : INTEGER := 16#28#;
    constant ADDR_Y_CTRL      : INTEGER := 16#2c#;
    constant ADDR_DONE_DATA_0 : INTEGER := 16#38#;
    constant ADDR_DONE_CTRL   : INTEGER := 16#3c#;
