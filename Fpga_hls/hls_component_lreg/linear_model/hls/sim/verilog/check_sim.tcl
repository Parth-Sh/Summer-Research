...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.linear_model.autotvin_x.dat"
         "c.linear_model.autotvin_m.dat"
         "c.linear_model.autotvin_c.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.linear_model.autotvout_y.dat"
         "rtl.linear_model.autotvout_done.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
